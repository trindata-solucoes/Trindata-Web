...
export default function Projetos() {
  ...
  return (
    <div className="min-h-screen bg-trindata-blue-light">
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie data={gastosPorCategoria} dataKey="value" nameKey="name" outerRadius={80}>
                        {gastosPorCategoria.map((_, i) => (<Cell key={i} fill={pieColors[i % pieColors.length]} />))}
                      </Pie>
                      <Tooltip />
                      <Legend />
                    </PieChart>
      ...
      <footer className="py-10 text-center text-xs text-gray-500">© {new Date().getFullYear()} TrinData. Todos os direitos reservados.</footer>
    </div>
  );
}
